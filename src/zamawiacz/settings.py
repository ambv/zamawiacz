# Django settings for zamawiacz project.
...
DATABASE_NAME = CURRENT_DIR + 'development.db'  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'kjss_jdn^lc($ils%4jsg#9a2h)@g*!ntalioxkydjy^!i05pm'
